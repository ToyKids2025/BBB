...
function AffiliatesView() {
  const [accounts, setAccounts] = useState([
    { id: 1, platform: 'amazon', account_tag: 'buscabr-20', owner: 'Principal', status: 'active' },
    { id: 2, platform: 'mercadolivre', account_tag: 'MLB123456', owner: 'Principal', status: 'active' }
  ]);
